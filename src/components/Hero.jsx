...
const Hero = () => {
  return (
    <div className="avif-bg relative w-full h-screen flex justify-center items-center">
      ...
      <img src="/sticker.png" alt="Hero Section" className="absolute -top-9 left-90 w-196 h-fit object-cover drop-shadow-xl select-none pointer-events-none" loading="lazy"/>
      <Navbar />
    </div>
  )
}
